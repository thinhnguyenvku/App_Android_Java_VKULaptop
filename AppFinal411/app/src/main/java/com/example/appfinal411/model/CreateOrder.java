...
import com.example.appfinal411.utils.AppInfo;
import com.example.appfinal411.zalo.Helper.Helpers;
import com.example.appfinal411.zalo.HttpProvider;
...
public class CreateOrder {
    private class CreateOrderData {
        ...
        private CreateOrderData(String amount) throws Exception {
            ...
            Items = "[]";
            BankCode = "zalopayapp";
            Description = "Thanh toán tại VKU LAPTOP " + Helpers.getAppTransId();
